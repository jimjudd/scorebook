...
# MLB team abbreviation -> team ID, for --team CHC on the CLI. The HTML
# picker doesn't need this -- it lists every game straight from the
# schedule endpoint without filtering by team.
TEAM_IDS = {
